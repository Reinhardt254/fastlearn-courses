  ...
  return (
    <div className='h-full w-full flex justify-center items-center'>
      <div className='px-2 md:w-2/3'>
        <p className='text-lg text-slate-900 my-3'>
...
We use the Order Information that we collect generally to fulfil any orders placed through the Site Paypal
...
If you have questions and/or require more information, do not hesitate to contact us on our contact us page.
